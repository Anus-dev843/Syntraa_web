    ...
    <div className="relative overflow-hidden border-b border-white/10 pb-28 pt-20 md:pb-36 md:pt-28">
      ...
      <div className="mx-auto max-w-3xl px-6 md:px-10 lg:px-12">
        <AnimatedSection>
          ...
          <h1 className="mt-5 font-display text-4xl leading-[1.03] text-luxury-snow md:text-6xl">
            Let&apos;s talk.
          </h1>
        ...
        <AnimatedSection delay={0.08} className="mt-14 space-y-10">
          <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.05] via-black/45 to-black p-8 md:p-10">
